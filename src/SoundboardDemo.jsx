                      ...
                      <div className="ui-sans" style={{ flex: 1, minWidth: 0, textAlign: "left" }}>
                        ...
                        {(r.favTrack || r.leastFavTrack) && (
                          <div style={{ fontSize: 11.5, color: MUTE, marginTop: 8, display: "flex", gap: 14, flexWrap: "wrap", textAlign: "left" }}>
                            {r.favTrack && <span style={{ display: "inline-flex", alignItems: "center", gap: 4 }}><svg width="12" height="11" viewBox="0 0 24 22" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z" stroke={MUTE} strokeWidth="1.8" fill="none" /></svg> {r.favTrack}</span>}
                            {r.leastFavTrack && <span style={{ display: "inline-flex", alignItems: "center", gap: 4 }}><svg width="12" height="12" viewBox="0 0 24 22" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2 8.5C2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09L12 7l-1 2.5 2 3-1.5 3.5-1 2.5-.05.03C5.4 15.36 2 12.28 2 8.5z" stroke={MUTE} strokeWidth="1.8" fill="none" /><path d="M22 8.5C22 5.42 19.58 3 16.5 3c-1.74 0-3.41.81-4.5 2.09L12 7l1-2.5-2 3 1.5 3.5 1 2.5.05.03C18.6 15.36 22 12.28 22 8.5z" stroke={MUTE} strokeWidth="1.8" fill="none" /></svg> {r.leastFavTrack}</span>}
                          </div>
                        )}
                      </div>
                    </div>
