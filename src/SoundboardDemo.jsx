...
import { Search, Heart, Plus, X, ChevronLeft, User, ListMusic, Check, Settings, Pencil, Bell, Frown, MessageCircle, Send, CornerUpLeft, UserPlus, AtSign, LayoutGrid } from "lucide-react";
      ...
      <div style={{ maxWidth: 920, margin: "0 auto", padding: ((view.name === "profile" && profile.profileTheme === "mspaint") || (view.name === "userProfile" && viewedUser?.profileTheme === "mspaint")) ? 0 : "28px 16px 64px", minHeight: "calc(100vh - 60px)", position: "relative", background: (view.name === "profile" ? (profile.pageBackground || "") : view.name === "userProfile" ? (viewedUser?.pageBackground || "") : "") || undefined, boxShadow: (view.name === "profile" ? (profile.pageBackground || "") : view.name === "userProfile" ? (viewedUser?.pageBackground || "") : "") ? `0 0 0 100vmax ${(view.name === "profile" ? profile.pageBackground : viewedUser?.pageBackground) || "transparent"}` : undefined, clipPath: (view.name === "profile" ? (profile.pageBackground || "") : view.name === "userProfile" ? (viewedUser?.pageBackground || "") : "") ? "inset(0 -100vmax)" : undefined, transition: "background 0.2s" }}>
        ...
        {view.name === "activity" && (
          <div>
            ...
            <div className="ui-sans" style={{ fontSize: 20, fontWeight: 700, marginBottom: 20 }}>{view.isOwn ? "your activity" : `@${(view.username || "").toLowerCase()} activity`}</div>
            <ActivityFeed
              items={activityItems}
                ...
                <div style={{ display: "flex", flexDirection: "column", justifyContent: "space-between", alignItems: "flex-end", flexShrink: 0, gap: 16 }}>
                  ...
                  {!isMobile && (
                    <div style={{ display: "flex", gap: 32, alignItems: "flex-start", flexShrink: 0, marginRight: 24 }}>
                      ...
                      <Stat label="activity" value={<LayoutGrid size={20} strokeWidth={1.8} />} onClick={() => openActivity(user.username, user.id, false)} />
              ...
              <div style={{ display: "flex", flexDirection: "column", justifyContent: "space-between", alignItems: "flex-end", flexShrink: 0, gap: 16 }}>
                ...
                {!isMobile && (
                  <div style={{ display: "flex", gap: 32, alignItems: "flex-start", flexShrink: 0, marginRight: 24 }}>
                    ...
                    <Stat label="activity" value={<LayoutGrid size={20} strokeWidth={1.8} />} onClick={() => openActivity(profile.username, profile.id, true)} />
