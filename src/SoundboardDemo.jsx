...
import { Search, Heart, Plus, X, ChevronLeft, User, ListMusic, Check, Settings, Pencil, Bell, Frown, MessageCircle, Send, CornerUpLeft, UserPlus, AtSign } from "lucide-react";
import MSPaintProfile from "./MSPaintProfile";
import AdminAddAlbum from "./AdminAddAlbum";
...
const STATS_TIERS = [
  { min: 10,  face: "grin",    title: "Real Love Baby",               blurb: "i genuinely admire how you view the world", blurbThird: "they view the world in a way worth admiring" },
  { min: 9.9, face: "grin",    title: "The Charming Man",             blurb: "im glad someone so handsome cares", blurbThird: "clearly someone with impeccable taste" },
  { min: 9.6, face: "grin",    title: "Semi-Charmed Life",            blurb: "you either have an open mind or the best music taste ever", blurbThird: "they've either got an open mind or the best taste ever" },
  { min: 9.5, face: "grin",    title: "A Love Supreme",               blurb: "you can't beat that", blurbThird: "you can't beat that" },
  { min: 9.0, face: "grin",    title: "Lust For Life",                blurb: "you see the world with rose colored glasses", blurbThird: "they see the world through rose colored glasses" },
  { min: 8.7, face: "grin",    title: "Lovefool",                     blurb: "you love almost everything you hear", blurbThird: "they love almost everything they hear" },
  { min: 8.0, face: "smile",   title: "Mr. Brightside",               blurb: "you see the good in things", blurbThird: "they see the good in things" },
  { min: 7.6, face: "smile",   title: "The Wild Kindness",            blurb: "you're generous but realistic", blurbThird: "they're generous but realistic" },
  { min: 7.0, face: "smile",   title: "The Modern Lover",             blurb: "you lean high", blurbThird: "they lean high" },
  { min: 6.9, face: "smile",   title: "The Funny Number",             blurb: "haha", blurbThird: "haha" },
  { min: 6.6, face: "neutral", title: "Sweet Jane",                   blurb: "you can be a bit of a fatal optimist", blurbThird: "a bit of a fatal optimist" },
  { min: 6.0, face: "neutral", title: "Sweet Disposition",            blurb: "you are a realist", blurbThird: "a realist" },
  { min: 5.0, face: "neutral", title: "Neither Heaven nor Las Vegas", blurb: "you're very middle of the road", blurbThird: "very middle of the road" },
  { min: 4.6, face: "frown",   title: "Negative Creep",               blurb: "idk, you might need some new music", blurbThird: "idk, they might need some new music" },
  { min: 4.0, face: "frown",   title: "El Scorcho",                   blurb: "that burns", blurbThird: "that burns" },
  { min: 3.0, face: "frown",   title: "Psycho Killer",                blurb: "you can be a bit harsh", blurbThird: "they can be a bit harsh" },
  { min: 2.5, face: "frown",   title: "Elvis Depressedly",            blurb: "lighten up a bit", blurbThird: "could lighten up a bit" },
  { min: 2.0, face: "frown",   title: "Meat Grinder",                 blurb: "tough crowd", blurbThird: "tough crowd" },
  { min: 1.6, face: "dead",    title: "Jude Jury and Executioner",    blurb: "You know you can show a little mercy, right?", blurbThird: "not exactly known for mercy" },
  { min: 0,   face: "dead",    title: "Miss Misery",                  blurb: "there's really no hope for you", blurbThird: "there's really no hope here" },
];
...
export default function SoundboardDemo() {
  ...
  const [customAccent, setCustomAccent] = useState(() => {
    try { return localStorage.getItem("spindex_accent") || null; } catch (e) { return null; }
  });
    ...
    <div style={{ fontFamily: "Helvetica Neue, Helvetica, Arial, sans-serif", background: BG, minHeight: "100%", color: INK, overflowX: "hidden", maxWidth: "100vw" }}>
      ...
      <div style={{ maxWidth: 920, margin: "0 auto", padding: ((view.name === "profile" && profile.profileTheme === "mspaint") || (view.name === "userProfile" && viewedUser?.profileTheme === "mspaint")) ? 0 : "28px 16px 64px", minHeight: "calc(100vh - 60px)", position: "relative", background: (view.name === "profile" ? (profile.pageBackground || "") : view.name === "userProfile" ? (viewedUser?.pageBackground || "") : "") || undefined, boxShadow: (view.name === "profile" ? (profile.pageBackground || "") : view.name === "userProfile" ? (viewedUser?.pageBackground || "") : "") ? `0 0 0 100vmax ${(view.name === "profile" ? profile.pageBackground : viewedUser?.pageBackground) || "transparent"}` : undefined, clipPath: (view.name === "profile" ? (profile.pageBackground || "") : view.name === "userProfile" ? (viewedUser?.pageBackground || "") : "") ? "inset(0 -100vmax)" : undefined, transition: "background 0.2s" }}>
        ...
        {view.name === "notifications" && (() => {
          const NOTIF_ICON = { reply: CornerUpLeft, reaction: Heart, follow: UserPlus, comment: MessageCircle, mention: AtSign };
          const NOTIF_TEXT = { reaction: "reacted to your review", follow: "started following you", comment: "commented on your review", reply: "replied to your comment", mention: "mentioned you" };
                  ...
                  return (
                    <div
                      ...
                      {...(isOwn ? {
                        ...
                        onDragOver: (e) => { e.preventDefault(); e.currentTarget.style.outline = `1px solid ${BLUE}`; },
        ...
        {view.name === "profile" && profile.profileTheme !== "mspaint" && (
          <div className="pf" data-theme={profile.profileTheme || ""} style={{ "--pf-navy": BLUE }}>
            ...
            {profile.profileTheme === "web2003" && (() => {
              ...
              const startEditing = () => {
                setInfoDrafts({ age: profile.age || "", town: profile.town || "", country: profile.country || "", interests: profile.interests || "", mood: profile.mood || "" });
                setInfoEditMode(true);
              };
              const saveAll = () => {
                saveProfileField({ age: infoDrafts.age.trim(), town: infoDrafts.town.trim(), country: infoDrafts.country.trim(), interests: infoDrafts.interests.trim(), mood: infoDrafts.mood });
              ...
              return (
                ...
                <div className="pf-infobox" style={{ maxWidth: 420, flex: "1 1 340px" }}>
                    ...
                    <div className="pf-inforow" key={r.key}>
                      ...
                      {infoEditMode ? (
                        <input
                          ...
                          value={infoDrafts[r.key]}
                          onChange={(e) => setInfoDrafts((d) => ({ ...d, [r.key]: e.target.value }))}
                          style={{ width: "90%" }}
                        />
                      ) : (
                        <span>{profile[r.key] || <span style={{ color: "#9aa" }}>—</span>}</span>
                      )}
                    </div>
                  ))}
                  <div className="pf-inforow">
                    <b>Mood</b>
                    {infoEditMode ? (
                      <select className="pf-mood-select" value={infoDrafts.mood} onChange={(e) => setInfoDrafts((d) => ({ ...d, mood: e.target.value }))}>
                        <option value="">—</option>
                  ...
                  {infoEditMode && (
                    <div style={{ display: "flex", gap: 8, padding: "10px 12px", background: "#eef1f8" }}>
                      <button className="pf-friendbtn" onClick={saveAll} style={{ cursor: "pointer" }}>save</button>
