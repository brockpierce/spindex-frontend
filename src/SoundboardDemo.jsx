...
import { Search, Heart, Plus, X, ChevronLeft, User, ListMusic, Check, Settings, Pencil, Bell, Frown, MessageCircle, Send, CornerUpLeft, UserPlus, AtSign, Music } from "lucide-react";
                ...
                <div style={{ display: "flex", flexDirection: "column", justifyContent: "space-between", alignItems: "flex-end", flexShrink: 0, gap: 16 }}>
                  ...
                  {!isMobile && (
                    <div style={{ display: "flex", gap: 32, alignItems: "flex-start", flexShrink: 0, marginRight: 24 }}>
                      ...
                      <Stat label="activity" value={<Music size={20} strokeWidth={1.8} />} onClick={() => openActivity(user.username, user.id, false)} />
              ...
              <div style={{ display: "flex", flexDirection: "column", justifyContent: "space-between", alignItems: "flex-end", flexShrink: 0, gap: 16 }}>
                ...
                {!isMobile && (
                  <div style={{ display: "flex", gap: 32, alignItems: "flex-start", flexShrink: 0, marginRight: 24 }}>
                    ...
                    <Stat label="activity" value={<Music size={20} strokeWidth={1.8} />} onClick={() => openActivity(profile.username, profile.id, true)} />
